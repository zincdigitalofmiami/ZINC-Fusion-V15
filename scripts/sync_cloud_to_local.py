...
def validate_cloud_database_url(database_url: str) -> str:
    """Validate that CLOUD_DATABASE_URL targets a direct, non-local Postgres endpoint."""
    ...
    if host in LOCAL_HOSTS:
        raise ValueError(
            f"CLOUD_DATABASE_URL must point to cloud for this sync, got local host {host!r}"
        )
    return database_url
