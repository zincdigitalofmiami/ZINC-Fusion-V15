...
from fusion.specialists.data_loaders import load_specialist_data, load_news_for_specialist
        ...
        try:
            ...
            if news_cols:
                ...
                if 'news_article_count' in df.columns:
                    ...
                    print(f'  📰 Articles: {total_articles:.0f} articles across {days_with_news} days')
                ...
                results[specialist] = {
                    ...
                    'total_articles': total_articles if 'news_article_count' in df.columns else 0
                }
            else:
                print(f'  ⚠️  No news columns found')
                results[specialist] = {'has_news': False, 'news_columns': 0, 'total_articles': 0}
