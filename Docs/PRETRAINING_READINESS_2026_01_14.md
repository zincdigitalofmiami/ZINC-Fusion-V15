...
- FX spot (1d): 59,105 rows | 1971-01-04 → 2025-12-26 | stale=19d
- CFTC COT (1w): 18,372 rows | 2006-06-13 → 2025-12-30 | stale=15d
- NOAA weather (1d): 215,320 rows | 2005-01-01 → 2025-12-20 | stale=25d
...
- News (event): 3,193 rows | 2017-05-08 → 2026-01-11 | stale=3d
...
### Blockers
- raw.fx_spot_1d stale 19d (>14d)
- raw.weather_noaa_1d stale 25d (>14d)
