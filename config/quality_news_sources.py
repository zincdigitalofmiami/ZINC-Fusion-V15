...
TRUMP_ZL_KEYWORDS = [
    "tariff", "china", "trade", "soybean", "farmer", "agriculture",
    "biodiesel", "ethanol", "energy", "fuel", "oil", "epa",
    "regulation", "import", "export", "brazil", "argentina"
]
...
SOURCE_METADATA = {
    "usda_press": {"name": "USDA Press Releases", "specialist": "crush", "update_freq": "daily"},
    "conab": {"name": "CONAB Brazil", "specialist": "crush", "update_freq": "monthly"},
    "farm_policy_news": {"name": "Farm Policy News", "specialist": "crush", "update_freq": "daily"},
    "farmdoc_daily": {"name": "FarmDoc Daily", "specialist": "crush", "update_freq": "daily"},
    "epa_news": {"name": "EPA Biofuel News", "specialist": "biofuel", "update_freq": "weekly"},
    "fed_news": {"name": "Federal Reserve", "specialist": "fed", "update_freq": "as_needed"},
    "truth_social": {"name": "Truth Social (Trump)", "specialist": "trump_effect", "update_freq": "realtime"},
    "mpob_news": {"name": "MPOB Malaysia", "specialist": "palm", "update_freq": "monthly"},
    "dtn_progressive": {"name": "DTN Progressive Farmer", "specialist": "crush", "update_freq": "daily"},
}


def get_all_quality_sources() -> set:
    """Get all sources worth processing (Tier 1-3)."""
    return TIER_1_CRITICAL | TIER_2_HIGH_VALUE | TIER_3_FINBERT_ONLY | TRUTH_SOCIAL_SOURCES


def get_claude_sources() -> set:
    """Get all sources worth Claude API credits."""
    return TIER_1_CRITICAL | TIER_PREMIUM_TWITTER | TIER_2_HIGH_VALUE | TRUTH_SOCIAL_SOURCES
