"""
ZINC Fusion V15 - Feature Engineering Module
=============================================

This module provides comprehensive feature engineering for the ZINC Fusion
soybean oil forecasting system.

Components:
-----------
1. technical_indicators: 130+ technical indicators using ta, TA-Lib, pandas-ta
2. specialist_buckets: Big-9 bucket-specific indicators (Crush, China, Energy, Biofuel, Substitutes, etc.)
3. regime_detection: Market regime classification and dynamic weighting

Usage:
------
    from quickstart_etl.features import (
