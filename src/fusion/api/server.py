...
def pulse_domains() -> Dict[str, Any]:
    ...
    return {
        ...
        "domain_descriptions": {
            "CRUSH": "Soybean Complex Fundamentals (28-35% variance)",
            "CHINA": "Trade Flows (16-22% variance)",
            "FX": "Currency Competitiveness (3-5% variance)",
            "FED": "Monetary Policy (2-4% variance)",
            "TARIFF": "Trade Policy (3-5% variance)",
            "ENERGY": "Crude Oil & Energy Complex (10-14% variance)",
            "BIOFUEL": "Biodiesel & Renewable Fuel (6-10% variance)",
